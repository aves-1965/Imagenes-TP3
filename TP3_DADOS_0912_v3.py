...
def generar_video_con_bbox(video_path, frame_idx_inicio_estatico, dados_detectados):
    ...
    output_filename = f"{base_name}_anotado_v3.mp4"
...
if frame_idx_estatico is not None:
    ...
    if ret:
        ...
        cv2.imwrite(f"{VIDEO_FILE.replace('.mp4', '')}_frame_estatico_v3.png", frame_estatico)
        ...
        print("\n--- RESULTADOS DE LA TIRADA 1 (VERSIÓN 3 - DETECCIÓN MEJORADA) ---")
